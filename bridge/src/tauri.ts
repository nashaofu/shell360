  ...
  return {
    ...
    data: {
      ...
      loadCryptoByPassword: (opts) =>
        jsb.invoke("data.loadCryptoByPassword", opts),
      changeCryptoPassword: (opts) =>
        jsb.invoke("data.changeCryptoPassword", opts),
      ...
      rotateCryptoKey: (password) =>
        jsb.invoke("data.rotateCryptoKey", { password }),
      ...
      updatePortForwarding: (value) =>
        jsb.invoke("data.updatePortForwarding", value),
      deletePortForwarding: (value) =>
        jsb.invoke("data.deletePortForwarding", value),
    },
    app: {
      ...direct.app,
    ...
    ssh: {
      createSession: (opts) => {
        ...
        return {
          sshSessionId,
          connect: (value, checkServerKey) =>
            jsb.invoke("ssh.session.connect", {
              sshSessionId,
              ...value,
              checkServerKey,
            }),
          authenticate_password: (value) =>
            jsb.invoke("ssh.session.authenticatePassword", {
              sshSessionId,
              ...value,
            }),
          authenticate_public_key: (value) =>
            jsb.invoke("ssh.session.authenticatePublicKey", {
              sshSessionId,
              ...value,
            }),
          authenticate_certificate: (value) =>
            jsb.invoke("ssh.session.authenticateCertificate", {
              sshSessionId,
              ...value,
            }),
          authenticate_keyboard_interactive: (value) =>
            jsb.invoke("ssh.session.authenticateKeyboardInteractive", {
              sshSessionId,
              ...value,
            }),
          authenticate_agent: (value) =>
            jsb.invoke("ssh.session.authenticateAgent", {
              sshSessionId,
              ...value,
            }),
          disconnect: () =>
            jsb.invoke("ssh.session.disconnect", { sshSessionId }),
        };
      },
      createShell: (session, opts) => {
        const sshShellId = uuidv4();
        jsb.on("ssh.shell.data", (payload, meta) => {
          if (meta?.targetId === sshShellId && typeof payload === "string")
        ...
        return {
          ...
          resize: (value) =>
            jsb.invoke("ssh.shell.resize", { sshShellId, size: value }),
        };
      },
      createSftp: (session, opts) => {
        ...
        return {
          sshSftpId,
          open: () =>
            jsb.invoke("ssh.sftp.open", {
              sshSessionId: session.sshSessionId,
              sshSftpId,
            }),
          close: () => jsb.invoke("ssh.sftp.close", { sshSftpId }),
          sftpReadDir: (path) =>
            jsb.invoke("ssh.sftp.readDir", { sshSftpId, path }),
          sftpUploadFile: (value) =>
            jsb.invoke("ssh.sftp.uploadFile", { sshSftpId, ...value }),
          sftpDownloadFile: (value) =>
            jsb.invoke("ssh.sftp.downloadFile", { sshSftpId, ...value }),
          sftpCreateFile: (path) =>
            jsb.invoke("ssh.sftp.createFile", { sshSftpId, path }),
          sftpCreateDir: (path) =>
            jsb.invoke("ssh.sftp.createDir", { sshSftpId, path }),
          sftpRemoveDir: (path) =>
            jsb.invoke("ssh.sftp.removeDir", { sshSftpId, path }),
          sftpRemoveFile: (path) =>
            jsb.invoke("ssh.sftp.removeFile", { sshSftpId, path }),
          sftpRename: (value) =>
            jsb.invoke("ssh.sftp.rename", { sshSftpId, ...value }),
          sftpExists: (path) =>
            jsb.invoke("ssh.sftp.exists", { sshSftpId, path }),
          sftpCanonicalize: (path) =>
            jsb.invoke("ssh.sftp.canonicalize", { sshSftpId, path }),
          sftpReadTextFile: (path) =>
            jsb.invoke("ssh.sftp.readTextFile", { sshSftpId, path }),
          sftpWriteTextFile: (path, content) =>
            jsb.invoke("ssh.sftp.writeTextFile", { sshSftpId, path, content }),
          sftpCancelTask: (taskId) =>
            jsb.invoke("ssh.sftp.cancelTask", { sshSftpId, taskId }),
          sftpPauseTask: (taskId) =>
            jsb.invoke("ssh.sftp.pauseTask", { sshSftpId, taskId }),
          sftpResumeTask: (taskId) =>
            jsb.invoke("ssh.sftp.resumeTask", { sshSftpId, taskId }),
        };
      },
      createPortForwarding: (session) => {
        const sshPortForwardingId = uuidv4();
        const invokeForward = (method: string, value?: object) =>
          jsb.invoke<unknown, string>(method, {
            sshSessionId: session.sshSessionId,
            sshPortForwardingId,
            ...value,
          });
        return {
          sshPortForwardingId,
          openLocalPortForwarding: (value) =>
            invokeForward("ssh.portForwarding.openLocal", value),
          closeLocalPortForwarding: () =>
            invokeForward("ssh.portForwarding.closeLocal"),
          openRemotePortForwarding: (value) =>
            invokeForward("ssh.portForwarding.openRemote", value),
          closeRemotePortForwarding: () =>
            invokeForward("ssh.portForwarding.closeRemote"),
          openDynamicPortForwarding: (value) =>
            invokeForward("ssh.portForwarding.openDynamic", value),
          closeDynamicPortForwarding: () =>
            invokeForward("ssh.portForwarding.closeDynamic"),
        };
      },
    },
    pty: {
      createShell: (opts) => {
        ...
        jsb.on("pty.shell.data", (payload, meta) => {
          if (meta?.targetId === shellId && typeof payload === "string")
            opts.onData?.(decodeBase64(payload));
        });
        jsb.on("pty.shell.exit", (payload, meta) => {
          if (meta?.targetId === shellId)
            opts.onExit?.(payload as number | null);
        });
        return {
          shellId,
          open: (value) => jsb.invoke("pty.shell.open", { shellId, ...value }),
          send: (value) =>
            jsb.invoke("pty.shell.send", {
              shellId,
              data: encodeBase64(
                typeof value === "string"
                  ? new TextEncoder().encode(value)
          ...
          resize: (value) =>
            jsb.invoke("pty.shell.resize", { shellId, size: value }),
    ...
    fs: {
      ...direct.fs,
      readTextFile: (path, opts) =>
        jsb.invoke("fs.readTextFile", { path, ...opts }),
      writeTextFile: (path, contents, opts) =>
        jsb.invoke("fs.writeTextFile", { path, contents, ...opts }),
    },
    clipboardManager: {
    ...
    store: {
      createStore: (path) => {
        ...
        return {
          get: <T>(key: string) =>
            jsb.invoke<unknown, T | null>("store.get", { storeId, key }),
          set: (key: string, value: unknown) =>
            jsb.invoke("store.set", { storeId, key, value }),
...
export function installTauriBackend(): void {
  ...
  transport.setLocalHandler(
    createTauriLocalHandler(direct, (event, payload, targetId) => {
...
function createTauriLocalHandler(
  ...
  return (method, params) => {
    switch (method) {
      case "data.checkIsEnableCrypto":
        return data.checkIsEnableCrypto();
      case "data.checkIsInitCrypto":
        return data.checkIsInitCrypto();
      case "data.checkIsAuthed":
        return data.checkIsAuthed();
      case "data.initCryptoKey":
        return data.initCryptoKey();
      case "data.initCryptoPassword":
        return data.initCryptoPassword(
          params as Parameters<typeof data.initCryptoPassword>[0],
        );
      case "data.loadCryptoByPassword":
        return data.loadCryptoByPassword(
          params as Parameters<typeof data.loadCryptoByPassword>[0],
        );
      case "data.changeCryptoPassword":
        return data.changeCryptoPassword(
          params as Parameters<typeof data.changeCryptoPassword>[0],
        );
      case "data.initCryptoBiometric":
        return data.initCryptoBiometric();
      case "data.loadCryptoByBiometric":
        return data.loadCryptoByBiometric();
      case "data.changeCryptoEnable":
        return data.changeCryptoEnable(
          params as Parameters<typeof data.changeCryptoEnable>[0],
        );
      case "data.resetCrypto":
        return data.resetCrypto();
      case "data.rotateCryptoKey":
        return data.rotateCryptoKey((params as { password: string }).password);
      case "data.getHosts":
        return data.getHosts();
      case "data.addHost":
        return data.addHost(params as Parameters<typeof data.addHost>[0]);
      case "data.updateHost":
        return data.updateHost(params as Parameters<typeof data.updateHost>[0]);
      case "data.deleteHost":
        return data.deleteHost(params as Parameters<typeof data.deleteHost>[0]);
      case "data.getKeys":
        return data.getKeys();
      case "data.addKey":
        return data.addKey(params as Parameters<typeof data.addKey>[0]);
      case "data.updateKey":
        return data.updateKey(params as Parameters<typeof data.updateKey>[0]);
      case "data.deleteKey":
        return data.deleteKey(params as Parameters<typeof data.deleteKey>[0]);
      case "data.getPortForwardings":
        return data.getPortForwardings();
      case "data.addPortForwarding":
        return data.addPortForwarding(
          params as Parameters<typeof data.addPortForwarding>[0],
        );
      case "data.updatePortForwarding":
        return data.updatePortForwarding(
          params as Parameters<typeof data.updatePortForwarding>[0],
        );
      case "data.deletePortForwarding":
        return data.deletePortForwarding(
          params as Parameters<typeof data.deletePortForwarding>[0],
        );
      case "dialog.open":
        return direct.dialog.openDialog(
          params as Parameters<BridgeBackend["dialog"]["openDialog"]>[0],
        );
      case "dialog.save":
        return direct.dialog.saveDialog(
          params as Parameters<BridgeBackend["dialog"]["saveDialog"]>[0],
        );
      case "dialog.destroyPath":
        return direct.dialog.destroyDialogPath(
          params as string | string[] | null,
        );
      ...
      case "clipboard.writeText":
        return writeText((params as { text: string }).text);
      ...
      case "machineUid.getMachineUid":
        return commands
          .getMachineUid()
          .then((result) =>
            result.status === "ok" ? result.data.id || undefined : undefined,
          );
      case "window.close":
        return direct.window.getCurrentWindow().close();
      case "store.create": {
      ...
      case "store.save":
        return stores.get((params as { storeId: string }).storeId)?.save();
      case "store.onKeyChange": {
        const value = params as { storeId: string; key: string };
        return stores
          .get(value.storeId)
          ?.onKeyChange(value.key, (nextValue) => {
      ...
      case "ssh.session.connect": {
        const value = params as {
          sshSessionId: string;
          checkServerKey?: unknown;
        } & Record<string, unknown>;
        const session =
          sessions.get(value.sshSessionId) ??
          direct.ssh.createSession({
            onDisconnect: (event) =>
              emit("ssh.session.disconnect", event.data, value.sshSessionId),
          });
        sessions.set(value.sshSessionId, session);
        return session.connect(value as never, value.checkServerKey as never);
      }
      case "ssh.session.authenticatePassword":
        return sessions
          .get((params as { sshSessionId: string }).sshSessionId)
          ?.authenticate_password(params as never);
      case "ssh.session.authenticatePublicKey":
        return sessions
          .get((params as { sshSessionId: string }).sshSessionId)
          ?.authenticate_public_key(params as never);
      case "ssh.session.authenticateCertificate":
        return sessions
          .get((params as { sshSessionId: string }).sshSessionId)
          ?.authenticate_certificate(params as never);
      case "ssh.session.authenticateKeyboardInteractive":
        return sessions
          .get((params as { sshSessionId: string }).sshSessionId)
          ?.authenticate_keyboard_interactive(params as never);
      case "ssh.session.authenticateAgent":
        return sessions
          .get((params as { sshSessionId: string }).sshSessionId)
          ?.authenticate_agent(params as never);
      ...
      case "ssh.shell.open": {
        ...
        const session = sessions.get(value.sshSessionId);
        if (!session)
          return Promise.reject(new Error("SSH session is not open."));
        const shell =
          shells.get(value.sshShellId) ??
          direct.ssh.createShell(session, {
            onData: (data) =>
              emit("ssh.shell.data", encodeBase64(data), value.sshShellId),
      ...
      case "ssh.shell.send":
        return shells
          .get((params as { sshShellId: string }).sshShellId)
          ?.send(decodeBase64((params as { data: string }).data));
      case "ssh.shell.resize":
        return shells
          .get((params as { sshShellId: string }).sshShellId)
          ?.resize((params as { size: never }).size);
      ...
      case "ssh.sftp.open": {
        ...
        if (!session)
          return Promise.reject(new Error("SSH session is not open."));
        const sftp =
          sftps.get(value.sshSftpId) ??
          direct.ssh.createSftp(session, {
      ...
      case "ssh.sftp.close":
        return sftps.get((params as { sshSftpId: string }).sshSftpId)?.close();
      case "ssh.sftp.readDir":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpReadDir((params as { path: string }).path);
      case "ssh.sftp.uploadFile":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpUploadFile(params as never);
      case "ssh.sftp.downloadFile":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpDownloadFile(params as never);
      case "ssh.sftp.createFile":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpCreateFile((params as { path: string }).path);
      case "ssh.sftp.createDir":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpCreateDir((params as { path: string }).path);
      case "ssh.sftp.removeDir":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpRemoveDir((params as { path: string }).path);
      case "ssh.sftp.removeFile":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpRemoveFile((params as { path: string }).path);
      case "ssh.sftp.rename":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpRename(params as never);
      case "ssh.sftp.exists":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpExists((params as { path: string }).path);
      case "ssh.sftp.canonicalize":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpCanonicalize((params as { path: string }).path);
      case "ssh.sftp.readTextFile":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpReadTextFile((params as { path: string }).path);
      case "ssh.sftp.writeTextFile":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpWriteTextFile(
      ...
      case "ssh.sftp.cancelTask":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpCancelTask((params as { taskId: string }).taskId);
      case "ssh.sftp.pauseTask":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpPauseTask((params as { taskId: string }).taskId);
      case "ssh.sftp.resumeTask":
        return sftps
          .get((params as { sshSftpId: string }).sshSftpId)
          ?.sftpResumeTask((params as { taskId: string }).taskId);
      case "ssh.portForwarding.openLocal":
        return getForwarding(direct, forwards, sessions, params).then(
          (forward) => forward.openLocalPortForwarding(params as never),
        );
      case "ssh.portForwarding.closeLocal":
        return forwards
          .get((params as { sshPortForwardingId: string }).sshPortForwardingId)
          ?.closeLocalPortForwarding();
      case "ssh.portForwarding.openRemote":
        return getForwarding(direct, forwards, sessions, params).then(
          (forward) => forward.openRemotePortForwarding(params as never),
        );
      case "ssh.portForwarding.closeRemote":
        return forwards
          .get((params as { sshPortForwardingId: string }).sshPortForwardingId)
          ?.closeRemotePortForwarding();
      case "ssh.portForwarding.openDynamic":
        return getForwarding(direct, forwards, sessions, params).then(
          (forward) => forward.openDynamicPortForwarding(params as never),
        );
      case "ssh.portForwarding.closeDynamic":
        return forwards
          .get((params as { sshPortForwardingId: string }).sshPortForwardingId)
          ?.closeDynamicPortForwarding();
      case "pty.shell.open": {
        ...
        const shell =
          ptyShells.get(value.shellId) ??
          direct.pty.createShell({
            onData: (data) =>
              emit("pty.shell.data", encodeBase64(data), value.shellId),
      ...
      case "pty.shell.send":
        return ptyShells
          .get((params as { shellId: string }).shellId)
          ?.send(decodeBase64((params as { data: string }).data));
      case "pty.shell.resize":
        return ptyShells
          .get((params as { shellId: string }).shellId)
          ?.resize((params as { size: never }).size);
...
async function getForwarding(
  ...
  const forwarding =
    forwards.get(value.sshPortForwardingId) ??
    direct.ssh.createPortForwarding(session);
